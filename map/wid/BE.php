...
#mapBE {
	background: url('/map-it/images/wid-BE.jpg') no-repeat;
	width:710px;
	height: 500px;
}

#toprow {
	padding:68px 15px 10px 126px;
}
        ...
        <div id="mapBE">
        	<div id="toprow">
       		...
       		<div id="leftcolumn">
       			...
       			<span id="row74" class="top5 tall-space"></span>
       			<span id="row73" class="top5"></span>
       		</div>
       		<div id="rightcolumn">
