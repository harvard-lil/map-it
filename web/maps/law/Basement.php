...
<body>
  ...
  <img src="/map-it/images/law/law-basement.jpg" alt="Law basement" class="print-map" />
        <div id="map1" class="map">
          <div class="main">
            <div class="wall">
              <span id="row11" class="wall2"></span><span id="row11" class="wall6"></span>
            </div>
            <div class="clear"></div>
            <div class="column1">
              ...
              <span id="row21" class="top4 shifted2"></span><span id="row22" class="bottom4 shifted2"></span>
              <span id="row21" class="top4 shifted2">
            </div>
            <div class="column2">
