...
#toprow {
	margin:56px 15px 10px 140px;
	float:left;
}

#rightcolumn {
	margin:25px 15px 10px 612px;
	width:100px;
	float:left;
}
  ...
  <img src="/map-it/images/wid/wid-1E.jpg" alt="Widener 1E" class="print-map" />
        <div id="map1E" class="map">
        	<div id="toprow">
       			...
       			<span id="row15" class="left3"></span><span id="row16" class="right3"></span>
       			<span id="row17" class="left3"></span><span id="row18" class="right3"></span>
       			<span id="row19" class="left3"></span><span id="row20" class="right3"></span>
       			...
       			<span id="row49" class="left7"></span><span id="row50" class="right7"></span>
       			<span id="row51" class="left7"></span><span id="row52" class="right7"></span>
       			<span id="row53" class="left7"></span><span id="row54" class="right7"></span>
       			<span id="row55" class="left7"></span><span id="row56" class="right7"></span>
       			<span id="row57" class="left7"></span><span id="row58" class="right7"></span>
