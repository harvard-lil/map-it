...
#toprow {
	margin:44px 15px 10px 58px;
	float:left;
}

#rightcolumn {
	float:left;
	margin:52px 15px 10px 32px;
	width:100px;
}

#leftcolumn {
	float:left;
	margin:32px 15px 10px 46px;
	width:55px;
}
...
<body>
  <img src="/map-it/images/wid/wid-DW.jpg" alt="Widener DW" class="print-map" />
        <div id="mapDW" class="map">
        	<div id="toprow">
