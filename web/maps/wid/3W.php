...
#bottomfull {
	margin:12px 0px 82px 22px;
	float:left;
}

#rightcolumntop {
	margin:36px 0px 10px 605px;
	float:left;
	width:100px;
}
...
<body>
  <img src="/map-it/images/wid/wid-3W.jpg" alt="Widener 3W" class="print-map" />
        <div id="map3W" class="map">
        	<div id="rightcolumntop">
       		...
       		<div class="clear"></div>
       		<div id="bottomfull">
       			<span id="row95" class="left8"></span><span id="row94" class="right8"></span>
